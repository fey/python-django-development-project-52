...
class TaskCreate(NoPermissionHandleMixin, AuthRequireMixin,
...
class TaskUpdate(NoPermissionHandleMixin, AuthRequireMixin,
...
class TaskDelete(NoPermissionHandleMixin, AuthRequireMixin, CheckTaskCreatorMixin,
