...
class TaskTest(TestCase):
    fixtures = ['users.json', 'task_statuses.json', 'labels.json', 'tasks.json', 'tasklabels.json']
    ...
    def test_filter(self):
        ...
        self.assertQuerysetEqual(response.context['task_list'], tasks, transform=identity)
