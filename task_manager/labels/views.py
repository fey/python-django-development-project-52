...
class LabelCreate(NoPermissionHandleMixin, AuthRequireMixin,
...
class LabelUpdate(NoPermissionHandleMixin, AuthRequireMixin,
...
class LabelDelete(NoPermissionHandleMixin, AuthRequireMixin,
