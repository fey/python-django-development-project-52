...
class UserUpdate(NoPermissionHandleMixin, AuthRequireMixin, CheckSelfUserMixin,
...
class UserDelete(NoPermissionHandleMixin, AuthRequireMixin, CheckSelfUserMixin,
    ...
    def post(self, request, *args, **kwargs):
        if self.get_object().creator.all().exists() or self.get_object().executor.all().exists():
